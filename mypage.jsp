	...
	<form><!-- 
		...
		<table style="width:450px; height:500px; border-color:#FEF2F6;">
			<tr style="background-color:#FEF2F6; border:none;" >
				<td colspan="2" align="left" style="border:none;"><h5 style="padding-left:10px;">회원 정보</h5></td>
			</tr>
			<!-- 여백 -->
			...
			<tr style="border:none;">
				...
				<td style="border:none;">
					...
					<a href="memberChange.jsp?mid='${mid}">
						<img src="images/pictogram/user-16.png" alt="Image">&nbsp;회원정보 수정 >
					</a>
					</h5>
				</td>
			</tr>
			...
			<tr style="background-color:#FEF2F6; border:none;" >
				<td style="border:none;">
					<h5 style="text-align:left; padding-left:10px;">회원의 반려동물 </h5>
				</td>
				<td style="border:none;">
					<h5 style="text-align:right; padding-right:10px;"><a href="inputpet.jsp?mid='${mid}'">반려동물 추가 > </a></h5>
				</td>
			</tr>
			<!-- 여백 -->
			<tr style="border:none;">
			...
			<tr style="border:none;">
				<td style="border:none;">
					<h5 style="padding-left:10px;">1. ${p.pname}(${p.pvarity})(${p.page})</h5>
				</td>
				<td style="text-align:right; padding-right:10px; border:none;">
					<h5><a href="petchange.jsp?pid='${p.pid}'" >정보 수정 > </a></h5>
				</td>
			</tr>
			</c:forEach>
			<!-- 펫 리스트 반복 --> 
			...
			<tr style="background-color:#FEF2F6; border:none;">
				<td align="center" style="border:none;">
					<h5><a href="#"><img src="images/pictogram/shopping-cart-16.png" alt="Image">&nbsp;장바구니</a></h5>
				</td>
				<td align="center" style="border:none;">
					<h5><a href="#">구매내역</a></h5>
				</td>
								...
								<table>
									<tr>
										...
										<td style="text-align: right; padding-right: 10px;">
											<a href="deleteM.do?mid='${mid}'"><button type="button" class="btn btn-default"
												>예</button></a>
										</td>
									</tr>
								</table>
