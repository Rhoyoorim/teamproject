			...
			<form method="post" name='petspecies' action="updateP.do">
				...
				<div class="form-group">
					<label class="text-black" for="pname">반려동물의 이름을 알려주세요!</label> <input
						...
						placeholder="예) 까미, 쿠키, 바둑이" value="${pname}" readonly>
				</div>
				<div class="form-group">
					<label class="text-black" for="pvarity">반려종을 선택해주세요!</label> 
					<input type="text" value="${pvarity}" name="pvarity">
				<span id="pdog" value="${pvarity}" >
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="pbirth" value="${pbirth}" readonly>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
				...
				<div class="form-group">
					<div data-v-9102220a="" class="my-pet-contents-input-wrapper">
						...
						<input type="text" name="pweight" value="${pweight}">
								...
								<table>
									<tr>
										...
										<td style="text-align: right; padding-right: 10px;">
											<a href="deleteP.do?pid='${pid}'"><button type="button" class="btn btn-default"
												>예</button></a>
										</td>
									</tr>
								</table>
