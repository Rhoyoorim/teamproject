...
<ryo:header/>
	...
	<div class="container pt-5 pb-5 mb-5 border-bottom">
		<div class="row justify-content-center">
			...
			<form method="post" name='signup' id='signup' action="insertM.do">
				...
				<div class="form-group">
					<label class="text-black" for="birthdate">생년월일*</label>
						<input type="date" class="form-control" id="mbirth" 
						name="mbirth" placeholder="선택"
		...
		function idcheck(){
			...
			$.ajax({
				...
				success : function(result){ // check에서 가져온 값 result 작성
					...
					if(result==1){
						$("#idcheck").text("사용가능한 아이디입니다!")// 사용가능
						$("#idcheck").css("color","blue");
						document.getElementById('submit').disabled=false;
					}
					else{
						$("#idcheck").text("이미 사용중인 아이디입니다...")// 사용중이라 사용 불가
